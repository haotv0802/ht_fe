...
import {Component, ComponentResolver, ViewChild,
  ViewContainerRef, ViewEncapsulation, ComponentRef, DynamicComponentLoader,
  ElementRef, Input, EventEmitter, Output} from '@angular/core';
